  ...
  return (
    <div className="activity">
      <div className="activity__left">
        <p className="activity_projectname">{activity.projectName}</p>
        <div className="activity__taskname">
          {activity.isBillable && (
            <span>
              <svg
                width="14"
          ...
          <span data-id={activity.id} className="delete-button">
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M10.5 0.25H5.5V1.5H10.5V0.25ZM0.5 2.75V4H1.75V16.5C1.75 17.25 2.25 17.75 3 17.75H13C13.75 17.75 14.25 17.25 14.25 16.5V4H15.5V2.75H0.5ZM3 16.5V4H13V16.5H3ZM5.5 6.5H6.75V14H5.5V6.5ZM10.5 6.5H9.25V14H10.5V6.5Z"
                fill="#525252"
              />
            </svg>
          </span>
